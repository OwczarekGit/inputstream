...
impl From<Group2Event> for evdev::Key {
    fn from(value: Group2Event) -> Self {
        use evdev::Key;
        match value {
            Group2Event::Num0 => Key::KEY_0,
            Group2Event::Num1 => Key::KEY_1,
            Group2Event::Num2 => Key::KEY_2,
            Group2Event::Num3 => Key::KEY_3,
            Group2Event::Num4 => Key::KEY_4,
            Group2Event::Num5 => Key::KEY_5,
            Group2Event::Num6 => Key::KEY_6,
            Group2Event::Num7 => Key::KEY_7,
            Group2Event::Num8 => Key::KEY_8,
            Group2Event::Num9 => Key::KEY_9,
...
impl From<Group3Event> for evdev::Key {
    fn from(value: Group3Event) -> Self {
        ...
        match value {
            ...
            Group3Event::Numpad0 => Key::KEY_NUMERIC_0,
            Group3Event::Numpad1 => Key::KEY_NUMERIC_1,
            Group3Event::Numpad2 => Key::KEY_NUMERIC_2,
            Group3Event::Numpad3 => Key::KEY_NUMERIC_3,
            Group3Event::Numpad4 => Key::KEY_NUMERIC_4,
            Group3Event::Numpad5 => Key::KEY_NUMERIC_5,
            Group3Event::Numpad6 => Key::KEY_NUMERIC_6,
            Group3Event::Numpad7 => Key::KEY_NUMERIC_7,
            Group3Event::Numpad8 => Key::KEY_NUMERIC_8,
            Group3Event::Numpad9 => Key::KEY_NUMERIC_9,
        }
    }
}
